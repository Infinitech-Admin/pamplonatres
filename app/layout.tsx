...
export const metadata: Metadata = {
  ...
  title: {
    default: "Barangay Pamplona Tres | Las Piñas City Official Portal",
    template: "%s | Barangay Pamplona Tres"
  },
  
  description: "Official digital platform of Barangay Pamplona Tres, Las Piñas City. Access barangay services, community updates, announcements, and connect with your local government. Serving 18,500+ residents with excellence.",
  ...
  authors: [{ name: "Barangay Pamplona Tres" }],
  creator: "Barangay Pamplona Tres",
  publisher: "Barangay Pamplona Tres, Las Piñas City",
  generator: "Next.js",
  applicationName: "Barangay Pamplona Tres Portal",
  ...
  openGraph: {
    ...
    title: "Barangay Pamplona Tres | Las Piñas City Official Portal",
    description: "Official digital platform of Barangay Pamplona Tres, Las Piñas City. Access barangay services, community updates, and connect with your local government.",
    siteName: "Barangay Pamplona Tres",
    images: [
      {
        url: "https://pamplonatres-laspinas.vercel.app/og-image.png",
        width: 1200,
        height: 630,
        alt: "Barangay Pamplona Tres - Las Piñas City Official Portal",
      },
    ],
  ...
  twitter: {
    ...
    title: "Barangay Pamplona Tres | Las Piñas City Official Portal",
    description: "Official digital platform of Barangay Pamplona Tres, Las Piñas City. Access barangay services, community updates, and local government resources.",
...
export default function RootLayout({
  ...
  const governmentSchema = {
    ...
    "alternateName": "Brgy. Pamplona Tres",
    "url": "https://pamplonatres-laspinas.vercel.app/",
    "logo": "https://pamplonatres-laspinas.vercel.app/icon512_rounded.png",
    "description": "Official barangay government of Pamplona Tres, Las Piñas City, Metro Manila. Serving 18,500+ residents with quality community services and transparent governance.",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "Barangay Pamplona Tres Hall",
    ...
    "areaServed": {
      "@type": "Place",
      "name": "Pamplona Tres, Las Piñas City"
    },
    "parentOrganization": {
      "@type": "GovernmentOrganization",
  ...
  const localBusinessSchema = {
    ...
    "name": "Barangay Pamplona Tres Hall",
  ...
  const websiteSchema = {
    ...
    "url": "https://pamplonatres-laspinas.vercel.app/",
    "name": "Barangay Pamplona Tres Portal",
    "description": "Official Portal of Barangay Pamplona Tres, Las Piñas City",
    "inLanguage": "en-PH",
    "publisher": {
      "@id": "https://pamplonatres-laspinas.vercel.app/#organization"
    },
  ...
  return (
    <html lang="en-PH">
      <head>
        ...
        <meta property="og:image:alt" content="Barangay Pamplona Tres - Las Piñas City" />
        
        {/* Twitter Card Image */}
        <meta name="twitter:image" content="https://pamplonatres-laspinas.vercel.app/twitter-image.png" />
        <meta name="twitter:image:alt" content="Barangay Pamplona Tres Portal" />
        ...
        <meta name="geo.placename" content="Barangay Pamplona Tres, Las Piñas City" />
        ...
        <meta name="coverage" content="Barangay Pamplona Tres, Las Piñas City, Metro Manila, Philippines" />
