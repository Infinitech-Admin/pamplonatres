...
export async function GET() {
  ...
  category: "hospital",
  address: "New Pamploma Tres Municipal Rd, Pamploma Tres City, Oriental Mindoro, Philippines",
  phone: "(043) 288-5130",
  ...
  category: "police",
  address: "Gov. Infantado St., Brgy. Guinobatan, Pamploma Tres City, Oriental Mindoro",
  phone: "(043) 288 2117",
  lat: 13.412269,
  lng: 121.181964,
  icon: "police",
  ...
  services: ["Emergency Response", "Crime Reporting", "Traffic Management"],
      ...
      {
  id: "3",
  name: "Pamploma Tres City Fire Station",
  category: "fire",
  address: "Gov. Infantado St., Brgy. Guinobatan, Pamploma Tres City, Oriental Mindoro",
  phone: "(043) 288 5617",
  lat: 13.412778,
...
},
{
  ...
  category: "government",
  address: "95HM+J5V, Pamploma Tres City, 5200 Oriental Mindoro",
  phone: "(043) 288 2496",
  lat: 13.411936,
  lng: 121.182499,
  icon: "government",
  ...
  category: "landmark",
  address: "JP Rizal St., Brgy. Ilaya, Pamploma Tres City, Oriental Mindoro",
  lat: 13.411205,
  lng: 121.178817,
  icon: "landmark",
