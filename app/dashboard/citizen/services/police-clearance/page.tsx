    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-100 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Learn how to obtain your police clearance certificate in Pamploma Tres City</p>
        </div>
          ...
          <CardHeader>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Police clearance is processed directly by the Philippine National Police (PNP). The City Government of Pamploma Tres does not issue police clearance certificates.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            <div className="bg-orange-50 p-4 rounded-lg">
              ...
              <div className="space-y-1 text-sm text-gray-700">
                <p>
                  <strong>Address:</strong> Pamploma Tres City Police Station, Oriental Mindoro
                </p>
                <p>
