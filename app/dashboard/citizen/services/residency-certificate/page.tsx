  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        toast({
          title: "Success!",
          description: "Your residency certificate application has been submitted.",
        })
      } else {
        ...
        <div className="min-h-screen bg-gradient-to-br from-green-50 to-teal-100 flex items-center justify-center p-4">
          <Card className="w-full max-w-md">
            <CardHeader className="text-center">
              ...
              <CardDescription>Your residency certificate application has been received</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="bg-green-50 p-4 rounded-lg">
                <p className="text-sm text-gray-600 mb-1">Reference Number</p>
                <p className="text-xl font-bold text-green-600">{referenceNumber}</p>
              </div>
              <div className="bg-teal-50 p-4 rounded-lg border border-teal-200">
                <p className="text-sm font-semibold text-teal-900 mb-2">What's Next?</p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-teal-100 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Residency Certificate Application</h1>
          <p className="text-gray-600">Apply for your certificate of residency</p>
        </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    required
                  />
                  <p className="text-xs text-gray-500">Please specify the reason why you need this certificate</p>
                </div>
              </div>
            )}
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  {formData.validId && (
                    <div className="flex items-center gap-2 p-2 bg-green-50 border border-green-200 rounded">
                      ...
                      <p className="text-sm text-green-800">File selected: {formData.validId.name}</p>
                    </div>
                  )}
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input 
                    ...
                    accept=".pdf,.jpg,.jpeg,.png" 
                  />
                  <p className="text-sm text-gray-500">Upload supporting documents like utility bills, lease contract, etc. (Optional)</p>
                  {formData.proofOfResidency && (
                    <div className="flex items-center gap-2 p-2 bg-green-50 border border-green-200 rounded">
                      <CheckCircle2 className="w-4 h-4 text-green-600" />
                      <p className="text-sm text-green-800">File selected: {formData.proofOfResidency.name}</p>
                    </div>
                  )}
                </div>
              </div>
