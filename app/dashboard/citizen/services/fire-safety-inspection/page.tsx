    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-100 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">Learn how to get your Fire Safety Inspection Certificate (FSIC) in Pamploma Tres City</p>
        </div>
          ...
          <CardHeader>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  Fire Safety Inspection Certificate (FSIC) is processed directly by the Bureau of Fire Protection (BFP). The City Government of Pamploma Tres does not issue FSIC. Please visit the BFP Pamploma Tres City Fire Station.
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          ...
          <CardContent>
            <div className="bg-orange-50 p-4 rounded-lg">
              ...
              <div className="space-y-1 text-sm text-gray-700">
                ...
                <p>
                  <strong>Address:</strong> Pamploma Tres City, Oriental Mindoro
                </p>
                <p>
                  <strong>Office Hours:</strong> Monday to Friday, 8:00 AM - 5:00 PM
                </p>
                <p className="text-xs text-gray-600 mt-2">
                  Note: Contact the BFP Pamploma Tres office for exact location and to schedule your inspection
                </p>
              </div>
            </div>
          </CardContent>
