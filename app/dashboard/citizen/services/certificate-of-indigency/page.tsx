...
export default function IndigencyCertificatePage() {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>, field: "validId" | "supportingDocument") => {
  ...
  const validateStep = () => {
    ...
    if (currentStep === 2) {
      ...
      if (!formData.yearsOfResidency || Number.parseInt(formData.yearsOfResidency) < 0) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        toast({
          title: "Success!",
          description: "Your indigency certificate application has been submitted.",
        })
      } else {
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
          <Card className="w-full max-w-md">
            <CardHeader className="text-center">
              ...
              <CardDescription>Your indigency certificate application has been received</CardDescription>
            </CardHeader>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-8 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-gray-900 mb-2">Certificate of Indigency Application</h1>
            <p className="text-gray-600">Apply for your barangay certificate of indigency</p>
          </div>
                ...
                <CardContent>
                  ...
                  {currentStep === 2 && (
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="reasonForIndigency">Reason for Indigency (Optional)</Label>
                        <Textarea
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-gray-500">
                          Upload a copy of your valid ID (PDF, JPG, PNG - Max 10MB)
                        </p>
                        {formData.validId && (
                      ...
                      <div className="space-y-2">
                        ...
                        />
                        <p className="text-sm text-gray-500">
                          Upload supporting documents for indigency verification (Optional)
                        </p>
                        {formData.supportingDocument && (
                          <div className="flex items-center gap-2 p-2 bg-blue-50 border border-blue-200 rounded">
                            <CheckCircle2 className="w-4 h-4 text-blue-600" />
                            <p className="text-sm text-blue-800">File selected: {formData.supportingDocument.name}</p>
                          </div>
                        )}
                      </div>
                      ...
                      <div className="p-4 bg-amber-50 border border-amber-200 rounded-lg">
                        ...
                        <p className="text-xs text-amber-700">
                          A Certificate of Indigency certifies that you are economically disadvantaged and need
                          financial assistance. This is commonly required for accessing government programs, financial
                  ...
                  {currentStep === 4 && (
                    <div className="space-y-6">
                      ...
                      <div>
                        <h3 className="font-semibold text-lg mb-3">Financial & Residency Information</h3>
                        <div className="grid grid-cols-2 gap-3 text-sm">
                          <div>
                          ...
                          <div>
                            ...
                            <p className="font-medium">{formData.numberOfDependents}</p>
                          </div>
                          <div className="col-span-2">
                          ...
                          {formData.reasonForIndigency && (
                            <div className="col-span-2">
                              <span className="text-gray-600">Reason for Indigency:</span>
                              <p className="font-medium">{formData.reasonForIndigency}</p>
                            </div>
                          )}
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          {formData.supportingDocument && (
                            <p>✓ Supporting Document: {formData.supportingDocument.name}</p>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                        <p className="text-sm text-blue-800">
                          By submitting this application, I certify that all information provided is true and correct to
