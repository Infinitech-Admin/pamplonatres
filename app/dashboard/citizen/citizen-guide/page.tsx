      ...
      items: [
        {
          ...
          content: "Learn how to register as a citizen of Pamploma Tres City and access all services.",
          fullContent: (
      ...
      items: [
        {
          ...
          content: "Step-by-step guide to apply for a business permit in Pamploma Tres City.",
          fullContent: (
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
        ...
        },
        {
          ...
          fullContent: (
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                A building permit is required for any construction, renovation, or structural modification in Pamploma Tres
                City.
              </p>
              <div className="space-y-3">
                <div>
      ...
      <main className="flex-1 px-4 py-6 pb-24 overflow-y-auto">
        <Card className="mb-6 border-orange-200 bg-orange-50">
          <CardContent className="p-4">
            <h2 className="font-semibold text-gray-900 mb-2">Welcome to Pamploma Tres City!</h2>
