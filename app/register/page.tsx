  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    if (!formData.voters_id) {
      ...
      toast({
        ...
        description: "Please upload your Voter's ID to continue with registration.",
        duration: 5000,
      })
      return
    }
      ...
      >
        <div className="card-premium p-10 md:p-12">
          ...
          >
            ...
            <p className="text-gray-600 text-lg">Join Pamploma Tres City System as a citizen</p>
          </motion.div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            >
              ...
              <motion.div variants={fieldVariants}>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Voters ID Upload *</label>
              ...
              <motion.div variants={fieldVariants} className="md:col-span-2">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 rounded-lg border border-orange-200 focus:border-orange-500 focus:ring-2 focus:ring-orange-200 transition"
                  placeholder="123 Main Street, Barangay 1, Pamploma Tres"
                  required
                />
              </motion.div>
            </motion.div>
